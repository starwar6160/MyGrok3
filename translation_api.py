...
def _unified_processing_generator(user_input, conversation_history, contains_chinese):
    """
    A single generator to handle the multi-step translation process.
    It yields text chunks and FinalStats objects.
    """
